...
from bernstein.evolution._shared import (
    COST_PER_PROPOSAL_USD as _COST_PER_PROPOSAL_USD,
)
from bernstein.evolution._shared import (
    FOCUS_ROTATION as _FOCUS_ROTATION,
)
from bernstein.evolution._shared import (
    FOCUS_ROTATION_COMMUNITY as _FOCUS_ROTATION_COMMUNITY,
)
from bernstein.evolution._shared import (
    ExperimentResult,
    infer_risk_level,
...
from bernstein.evolution._shared import (
    log_experiment as _log_experiment_impl,
)
from bernstein.evolution._shared import (
    to_types_proposal as _to_types_proposal,
)
...
class EvolutionLoop:
    ...
    def _log_experiment(self, result: ExperimentResult) -> None:
        ...
        _log_experiment_impl(self._experiments_path, result)
    ...
    def _log_deferred(self, proposal: UpgradeProposal, reason: str) -> None:
        ...
        _log_deferred_impl(self._deferred_path, proposal, reason)
    ...
    def _infer_risk_level(proposal: UpgradeProposal) -> RiskLevel:
        ...
        return infer_risk_level(proposal)
