...
- `main` — CLI entry point for Bernstein -- multi-agent orchestration. [_RichGroup, cli, add_task, sync, cancel, approve]
...
- `costs` — Cost budget routes. [get_cost_budget]
...
- `task_lifecycle` — Task lifecycle: claim, spawn, complete, retry, decompose. [collect_completion_data, check_file_overlap, maybe_retry_task, retry_or_fail_task, should_auto_decompose, auto_decompose_task]
