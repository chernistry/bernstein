...
DICEWARE_WORDS: tuple[str, ...] = (
    "amber", "anchor", "apple", "arrow", "atlas", "aurora", "autumn", "azure",
    "bacon", "badge", "bagel", "bamboo", "banjo", "basil", "beacon", "bear",
    "berry", "birch", "bison", "blaze", "bloom", "blossom", "bolt", "bonus",
    "boots", "border", "bossa", "boulder", "bowtie", "branch", "brass", "bravo",
    "breeze", "bridge", "bright", "bronze", "brook", "buffer", "bugle", "bumper",
    "bundle", "butter", "cabin", "cable", "cactus", "candle", "canoe", "canyon",
    "carbon", "carrot", "castle", "catnip", "cedar", "cello", "champ", "chant",
    "cherry", "chess", "chime", "circle", "citrus", "clamp", "clay", "clever",
    "cliff", "clover", "cobalt", "cocoa", "comet", "coral", "cosmic", "cotton",
    "coyote", "cozy", "crane", "creek", "crisp", "cronos", "crown", "crystal",
    "cubic", "cumin", "cypress", "daisy", "dawn", "delta", "diamond", "dolphin",
    "donut", "drift", "dunes", "dynamo", "eagle", "earth", "ebony", "echo",
    "eclipse", "edge", "elder", "elf", "ember", "emerald", "ember2", "epoch",
    "ether", "etna", "evening", "fable", "falcon", "felt", "fern", "fiber",
    "fiddle", "field", "finch", "firefly", "fjord", "flame", "flax", "fleece",
    "flint", "flora", "foam", "fog", "forest", "forge", "fox", "frost",
    "galaxy", "garnet", "geyser", "ginger", "glacier", "glade", "glass", "glide",
    "glow", "gnome", "golden", "granite", "grape", "graphite", "grasp", "grasshop",
    "gravel", "grizzly", "groove", "harbor", "harvest", "haven", "hawk", "hazel",
    "helix", "heron", "hibis", "hickory", "hill", "honey", "horizon", "hum",
    "iceberg", "indigo", "iris", "ivy", "jade", "jasmine", "jazz", "jewel",
    "juniper", "kayak", "kelp", "kestrel", "kettle", "knight", "koi", "lake",
    "lantern", "lattice", "lava", "lemon", "leopard", "lily", "linden", "lion",
    "lizard", "lobster", "locust", "loop", "lotus", "lumen", "lumber", "lupine",
    "lyric", "macaw", "mango", "maple", "marble", "mark", "marlin", "marmot",
    "meadow", "melody", "merlin", "mesa", "metric", "mica", "midnight", "millet",
    "mint", "mist", "moon", "moose", "mosaic", "mountain", "mulberry", "muse",
    "nebula", "needle", "nest", "nettle", "newt", "nimbus", "noble", "nomad",
    "north", "nova", "nutmeg", "oak", "oasis", "ocean", "ochre", "ocelot",
    "olive", "onyx", "opal", "orca", "orchid", "orion", "otter", "owl",
    "oxide", "paddle", "panda", "pansy", "papaya", "parchment", "parrot", "pearl",
    "pebble", "penguin", "petunia", "pewter", "phoenix", "pine", "pioneer", "plover",
    "plum", "polar", "poplar", "poppy", "prairie", "prism", "puffin", "quartz",
)
