...
**Контроль.** Аудит-логи с цепочкой HMAC, движок политик, гейтинг PII в выводе, восстановление после краша на базе WAL (экспериментальная безопасность многопроцессного режима), OAuth 2.0 PKCE.
