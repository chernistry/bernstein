...
| `metrics.py`                                        | Performance metrics collection and storage |
...
| `routes/`                                           | FastAPI router modules for the Bernstein task server (agents, costs, dashboard, status, tasks, webhooks.py) |
